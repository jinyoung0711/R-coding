...
# google
# (1) URL 요청
url1 <- "https://www.google.com/search?q=Data+analysis&hl=en&source=lnms&tbm=nws&sa=X&ved=2ahUKEwifgKOYmMD0AhWIyosBHaQWDW8Q_AUoA3oECAEQBQ&biw=1920&bih=969&dpr=1"
web1 <- GET(url1)
web1
...
# FOX
# (1) URL 요청
url2 <- "https://www.foxnews.com/search-results/search?q=Data%20analysis"
web2 <- GET(url2)
web2
