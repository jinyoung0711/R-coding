...
# 한국일보 _ 빅데이터
# (1) URL 요청
url1 <- "https://search.hankookilbo.com/Search?tab=NEWS&sort=recent&searchText=%EB%B9%85%EB%8D%B0%EC%9D%B4%ED%84%B0&selectedPeriod=%EC%A0%84%EC%B2%B4&filter=head"
web1<- GET(url1)
web1
...
#SBS _ 빅데이터
# (1) URL 요청
url2 <- "https://news.sbs.co.kr/news/search/main.do?pageIdx=1&searchTermStartDate=&searchTermEndDate=&searchSection=01%7C02%7C03%7C07%7C08%7C09%7C14&searchCategory=&searchMode=&query=%EB%B9%85%EB%8D%B0%EC%9D%B4%ED%84%B0&collection=nnews&searchOption=1&searchStartDate=&searchEndDate="
web2 <- GET(url2)
web2
...
# (1) NAVER URL 요청
url3 <- "https://search.naver.com/search.naver?where=news&query=%EB%B9%85%EB%8D%B0%EC%9D%B4%ED%84%B0&sm=tab_opt&sort=1&photo=0&field=0&pd=0&ds=&de=&docid=&related=0&mynews=0&office_type=0&office_section_code=0&news_office_checked=&nso=so%3Add%2Cp%3Aall&is_sug_officeid=0"
web3 <- GET(url3)
web3
